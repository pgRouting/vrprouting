...
::
    ...
    vrp_pickDeliverEuclidean(Orders SQL, Vehicles SQL [, factor, max_cycles, initial_sol])
    RETURNS SET OF:
...
--v0.0
CREATE FUNCTION vrp_pickDeliverEuclidean(
...
$BODY$
    SELECT *
    FROM _vrp_pickDeliverEuclidean(_pgr_get_statement($1), _pgr_get_statement($2), $3, $4, $5);
$BODY$
LANGUAGE SQL VOLATILE STRICT;

-- COMMENTS

COMMENT ON FUNCTION vrp_pickDeliverEuclidean(TEXT, TEXT, FLOAT, INTEGER, INTEGER)
IS 'vrp_pickDeliverEuclidean
 - EXPERIMENTAL
 - Parameters:
