...
BEGIN
  ...
  SELECT set_eq('vroom_sql',
    $$
      ...
      (4, 1, 1, 4, 3, 5, 1500, 0, 2250, 11850, ARRAY[40]),
      (5, 1, 1, 5, 3, 3, 15650, 50, 2250, 0, ARRAY[60]),
      (6, 1, 1, 6, 4, 5, 17950, 50, 2250, 225, ARRAY[50]),
      (7, 1, 1, 7, 4, 3, 20425, 0, 2250, 200, ARRAY[30]),
      (8, 1, 1, 8, 6, -1, 22925, 50, 0, 0, ARRAY[30]),
      (9, 1, 1, 0, 0, 0, 0, 200, 9250, 13175, ARRAY[]::INTEGER[]),
      (10, 2, 2, 1, 1, -1, 275, 0, 0, 0, ARRAY[70]),
      (11, 2, 2, 2, 5, 2, 275, 0, 10, 0, ARRAY[70]),
      (12, 2, 2, 3, 2, 5, 360, 75, 250, 665, ARRAY[70]),
      (13, 2, 2, 4, 2, 3, 1325, 50, 250, 1400, ARRAY[70]),
      (14, 2, 2, 5, 2, 4, 2975, 0, 250, 550, ARRAY[70]),
      (15, 2, 2, 6, 6, -1, 3775, 0, 0, 0, ARRAY[70]),
      (16, 2, 2, 0, 0, 0, 0, 125, 760, 2615, ARRAY[]::INTEGER[]),
      (17, 3, 3, 1, 1, -1, 0, 0, 0, 0, ARRAY[20]),
      (18, 3, 3, 2, 5, 3, 0, 0, 0, 0, ARRAY[20]),
      (19, 3, 3, 3, 2, 1, 0, 0, 250, 3625, ARRAY[20]),
      (20, 3, 3, 4, 3, 4, 3875, 0, 2250, 2500, ARRAY[40]),
      (21, 3, 3, 5, 4, 4, 8700, 75, 2250, 225, ARRAY[20]),
      (22, 3, 3, 6, 6, -1, 11250, 75, 0, 0, ARRAY[20]),
      (23, 3, 3, 0, 0, 0, 0, 150, 4750, 6350, ARRAY[]::INTEGER[]),
      (24, 4, 4, 1, 1, -1, 250, 0, 0, 0, ARRAY[0]),
      (25, 4, 4, 2, 5, 4, 250, 0, 0, 0, ARRAY[0]),
      (26, 4, 4, 3, 3, 2, 275, 25, 2250, 100, ARRAY[10]),
      (27, 4, 4, 4, 3, 1, 2650, 25, 2250, 0, ARRAY[20]),
      (28, 4, 4, 5, 4, 2, 4990, 90, 2250, 0, ARRAY[10]),
      (29, 4, 4, 6, 4, 1, 7351, 111, 2250, 17574, ARRAY[0]),
      (30, 4, 4, 7, 6, -1, 27200, 25, 0, 0, ARRAY[0]),
      (31, 4, 4, 0, 0, 0, 0, 276, 9000, 17674, ARRAY[]::INTEGER[]),
      (32, 0, 0, 0, 0, 0, 0, 751, 23760, 39814, ARRAY[]::INTEGER[])
    $$,
  ...
  SELECT set_eq('one_job_q1',
    $$
      ...
      (5, 1, 1, 0, 0, 0, 0, 0, 250, 3325, ARRAY[]::INTEGER[]),
      (6, 0, 0, 0, 0, 0, 0, 0, 250, 3325, ARRAY[]::INTEGER[])
    $$,
  ...
  SELECT set_eq('one_job_q2',
    $$
      ...
      (4, 1, 4, 4, 6, -1, 1325, 50, 0, 0, ARRAY[20]),
      (5, 1, 4, 0, 0, 0, 0, 100, 250, 725, ARRAY[]::INTEGER[]),
      (6, 0, 0, 0, 0, 0, 0, 100, 250, 725, ARRAY[]::INTEGER[])
    $$,
  ...
  SELECT set_eq('one_shipment_q1',
    $$
      ...
      (5, 1, 4, 5, 6, -1, 27200, 25, 0, 0, ARRAY[0]),
      (6, 1, 4, 0, 0, 0, 0, 50, 4500, 22400, ARRAY[]::INTEGER[]),
      (7, 0, 0, 0, 0, 0, 0, 50, 4500, 22400, ARRAY[]::INTEGER[])
    $$,
  ...
  SELECT set_eq('one_shipment_q2',
    $$
      ...
      (4, 1, 1, 4, 4, 5, 15600, 0, 2250, 2575, ARRAY[0]),
      (5, 1, 1, 5, 6, -1, 20475, 50, 0, 0, ARRAY[0]),
      (6, 1, 1, 0, 0, 0, 0, 100, 4500, 15575, ARRAY[]::INTEGER[]),
      (7, 0, 0, 0, 0, 0, 0, 100, 4500, 15575, ARRAY[]::INTEGER[])
    $$,
  ...
  SELECT set_eq('one_job_shipment',
    $$
      ...
      (2, 1, 1, 2, 5, 1, 300, 0, 0, 0, ARRAY[30]),
      (3, 1, 1, 3, 2, 2, 350, 50, 250, 900, ARRAY[30]),
      (4, 1, 1, 4, 6, -1, 1550, 50, 0, 0, ARRAY[30]),
      (5, 1, 1, 0, 0, 0, 0, 100, 250, 900, ARRAY[]::INTEGER[]),
      (6, 2, 4, 1, 1, -1, 250, 0, 0, 0, ARRAY[0]),
      (7, 2, 4, 2, 5, 4, 250, 0, 0, 0, ARRAY[0]),
      (8, 2, 4, 3, 3, 2, 275, 25, 2250, 100, ARRAY[10]),
      (9, 2, 4, 4, 4, 2, 2736, 111, 2250, 1514, ARRAY[0]),
      (10, 2, 4, 5, 6, -1, 6590, 90, 0, 0, ARRAY[0]),
      (11, 2, 4, 0, 0, 0, 0, 226, 4500, 1614, ARRAY[]::INTEGER[]),
      (12, 0, 0, 0, 0, 0, 0, 326, 4750, 2514, ARRAY[]::INTEGER[])
    $$,
  ...
  SELECT set_eq('exploration_level_0',
    $$
      ...
      (6, 1, 1, 6, 3, 5, 11265, 90, 2250, 2085, ARRAY[30]),
      (7, 1, 1, 7, 3, 3, 15650, 50, 2250, 0, ARRAY[50]),
      (8, 1, 1, 8, 4, 5, 17950, 50, 2250, 225, ARRAY[40]),
      (9, 1, 1, 9, 4, 3, 20425, 0, 2250, 200, ARRAY[20]),
      (10, 1, 1, 10, 6, -1, 22925, 50, 0, 0, ARRAY[20]),
      (11, 1, 1, 0, 0, 0, 0, 315, 13750, 8560, ARRAY[]::INTEGER[]),
      (12, 2, 2, 1, 1, -1, 275, 0, 0, 0, ARRAY[50]),
      (13, 2, 2, 2, 5, 2, 275, 0, 10, 0, ARRAY[50]),
      (14, 2, 2, 3, 2, 2, 335, 50, 250, 915, ARRAY[50]),
      (15, 2, 2, 4, 2, 5, 1590, 90, 250, 0, ARRAY[50]),
      (16, 2, 2, 5, 3, 1, 1890, 50, 2250, 0, ARRAY[60]),
      (17, 2, 2, 6, 4, 1, 4165, 25, 2250, 20760, ARRAY[50]),
      (18, 2, 2, 7, 6, -1, 27200, 25, 0, 0, ARRAY[50]),
      (19, 2, 2, 0, 0, 0, 0, 240, 5010, 21675, ARRAY[]::INTEGER[]),
      (20, 3, 4, 1, 1, -1, 250, 0, 0, 0, ARRAY[50]),
      (21, 3, 4, 2, 5, 4, 250, 0, 0, 0, ARRAY[50]),
      (22, 3, 4, 3, 3, 2, 275, 25, 2250, 100, ARRAY[60]),
      (23, 3, 4, 4, 2, 3, 2650, 25, 250, 75, ARRAY[60]),
      (24, 3, 4, 5, 2, 4, 2975, 0, 250, 550, ARRAY[60]),
      (25, 3, 4, 6, 4, 2, 3865, 90, 2250, 385, ARRAY[50]),
      (26, 3, 4, 7, 6, -1, 6590, 90, 0, 0, ARRAY[50]),
      (27, 3, 4, 0, 0, 0, 0, 230, 5000, 1110, ARRAY[]::INTEGER[]),
      (28, 0, 0, 0, 0, 0, 0, 785, 23760, 31345, ARRAY[]::INTEGER[])
    $$,
  ...
  SELECT set_eq('timeout_0',
    $$
      ...
      (4, 1, 1, 4, 2, 5, 1590, 90, 250, 0, ARRAY[110]),
      (5, 1, 1, 5, 2, 4, 1890, 50, 250, 1635, ARRAY[110]),
      (6, 1, 1, 6, 2, 1, 3865, 90, 250, 0, ARRAY[110]),
      (7, 1, 1, 7, 6, -1, 4115, 0, 0, 0, ARRAY[110]),
      (8, 1, 1, 0, 0, 0, 0, 280, 1000, 2535, ARRAY[]::INTEGER[]),
      (9, 2, 4, 1, 1, -1, 250, 0, 0, 0, ARRAY[10]),
      (10, 2, 4, 2, 5, 4, 250, 0, 0, 0, ARRAY[10]),
      (11, 2, 4, 3, 3, 2, 275, 25, 2250, 100, ARRAY[20]),
      (12, 2, 4, 4, 2, 3, 2650, 25, 250, 75, ARRAY[20]),
      (13, 2, 4, 5, 3, 1, 2975, 0, 2250, 0, ARRAY[30]),
      (14, 2, 4, 6, 4, 2, 5315, 90, 2250, 0, ARRAY[20]),
      (15, 2, 4, 7, 3, 4, 7692, 127, 2250, 0, ARRAY[40]),
      (16, 2, 4, 8, 4, 4, 10017, 75, 2250, 0, ARRAY[20]),
      (17, 2, 4, 9, 3, 5, 12357, 90, 2250, 993, ARRAY[30]),
      (18, 2, 4, 10, 3, 3, 15650, 50, 2250, 0, ARRAY[50]),
      (19, 2, 4, 11, 4, 5, 17950, 50, 2250, 225, ARRAY[40]),
      (20, 2, 4, 12, 4, 3, 20425, 0, 2250, 200, ARRAY[20]),
      (21, 2, 4, 13, 4, 1, 23020, 145, 2250, 1905, ARRAY[10]),
      (22, 2, 4, 14, 6, -1, 27200, 25, 0, 0, ARRAY[10]),
      (23, 2, 4, 0, 0, 0, 0, 702, 22750, 3498, ARRAY[]::INTEGER[]),
      (24, 0, 0, 0, 0, 0, 0, 982, 23750, 6033, ARRAY[]::INTEGER[])
    $$,
  ...
  SELECT set_eq('problem_0_tasks',
    $$
      VALUES
      (1, 1, -1, 1, 4, 5, 0, 0, 0, 0, ARRAY[]::INTEGER[]),
      (2, 1, -1, 2, 3, 5, 0, 0, 0, 0, ARRAY[]::INTEGER[]),
      (3, 1, -1, 3, 2, 1, 0, 0, 0, 0, ARRAY[]::INTEGER[]),
      (4, 1, -1, 4, 2, 2, 0, 0, 0, 0, ARRAY[]::INTEGER[]),
      (5, 1, -1, 5, 2, 3, 0, 0, 0, 0, ARRAY[]::INTEGER[]),
      (6, 1, -1, 6, 2, 4, 0, 0, 0, 0, ARRAY[]::INTEGER[]),
      (7, 1, -1, 7, 2, 5, 0, 0, 0, 0, ARRAY[]::INTEGER[]),
      (8, 1, -1, 8, 3, 1, 0, 0, 0, 0, ARRAY[]::INTEGER[]),
      (9, 1, -1, 9, 4, 1, 0, 0, 0, 0, ARRAY[]::INTEGER[]),
      (10, 1, -1, 10, 3, 2, 0, 0, 0, 0, ARRAY[]::INTEGER[]),
      (11, 1, -1, 11, 4, 2, 0, 0, 0, 0, ARRAY[]::INTEGER[]),
      (12, 1, -1, 12, 3, 3, 0, 0, 0, 0, ARRAY[]::INTEGER[]),
      (13, 1, -1, 13, 4, 3, 0, 0, 0, 0, ARRAY[]::INTEGER[]),
      (14, 1, -1, 14, 3, 4, 0, 0, 0, 0, ARRAY[]::INTEGER[]),
      (15, 1, -1, 15, 4, 4, 0, 0, 0, 0, ARRAY[]::INTEGER[]),
      (16, 0, 0, 0, 0, 0, 0, 0, 0, 0, ARRAY[]::INTEGER[])
    $$,
  ...
  SELECT set_eq('problem_1_task',
    $$
      ...
      (4, 1, 1, 4, 6, -1, 1550, 50, 0, 0, ARRAY[30]),
      (5, 1, 1, 0, 0, 0, 0, 100, 250, 900, ARRAY[]::INTEGER[]),
      (6, 2, 2, 1, 1, -1, 275, 0, 0, 0, ARRAY[10]),
      (7, 2, 2, 2, 5, 2, 275, 0, 10, 0, ARRAY[10]),
      (8, 2, 2, 3, 2, 3, 375, 90, 250, 2350, ARRAY[10]),
      (9, 2, 2, 4, 6, -1, 2975, 0, 0, 0, ARRAY[10]),
      (10, 2, 2, 0, 0, 0, 0, 90, 260, 2350, ARRAY[]::INTEGER[]),
      (11, 3, 3, 1, 1, -1, 0, 0, 0, 0, ARRAY[20]),
      (12, 3, 3, 2, 5, 3, 0, 0, 0, 0, ARRAY[20]),
      (13, 3, 3, 3, 2, 1, 0, 0, 250, 3625, ARRAY[20]),
      (14, 3, 3, 4, 6, -1, 3875, 0, 0, 0, ARRAY[20]),
      (15, 3, 3, 0, 0, 0, 0, 0, 250, 3625, ARRAY[]::INTEGER[]),
      (16, 4, 4, 1, 1, -1, 250, 0, 0, 0, ARRAY[40]),
      (17, 4, 4, 2, 5, 4, 250, 0, 0, 0, ARRAY[40]),
      (18, 4, 4, 3, 2, 4, 250, 0, 250, 3275, ARRAY[40]),
      (19, 4, 4, 4, 6, -1, 3775, 0, 0, 0, ARRAY[40]),
      (20, 4, 4, 0, 0, 0, 0, 0, 250, 3275, ARRAY[]::INTEGER[]),
      (21, 5, -1, 1, 4, 5, 0, 0, 0, 0, ARRAY[]::INTEGER[]),
      (22, 5, -1, 2, 3, 5, 0, 0, 0, 0, ARRAY[]::INTEGER[]),
      (23, 5, -1, 3, 2, 5, 0, 0, 0, 0, ARRAY[]::INTEGER[]),
      (24, 5, -1, 4, 3, 1, 0, 0, 0, 0, ARRAY[]::INTEGER[]),
      (25, 5, -1, 5, 4, 1, 0, 0, 0, 0, ARRAY[]::INTEGER[]),
      (26, 5, -1, 6, 3, 2, 0, 0, 0, 0, ARRAY[]::INTEGER[]),
      (27, 5, -1, 7, 4, 2, 0, 0, 0, 0, ARRAY[]::INTEGER[]),
      (28, 5, -1, 8, 3, 3, 0, 0, 0, 0, ARRAY[]::INTEGER[]),
      (29, 5, -1, 9, 4, 3, 0, 0, 0, 0, ARRAY[]::INTEGER[]),
      (30, 5, -1, 10, 3, 4, 0, 0, 0, 0, ARRAY[]::INTEGER[]),
      (31, 5, -1, 11, 4, 4, 0, 0, 0, 0, ARRAY[]::INTEGER[]),
      (32, 0, 0, 0, 0, 0, 0, 190, 1010, 10150, ARRAY[]::INTEGER[])
    $$,
  ...
  SELECT * FROM vrp_vroomPlain(
    'SELECT id, location_id, service, delivery, pickup, ARRAY[]::INTEGER[]::INTEGER[] AS skills, priority FROM jobs',
    'jobs_time_windows',
    'SELECT id, p_location_id, p_service, d_location_id, d_service, amount, ARRAY[]::INTEGER[]::INTEGER[] AS skills, priority FROM shipments',
    'shipments_time_windows',
    'SELECT id, start_id, end_id, capacity, ARRAY[]::INTEGER[]::INTEGER[] AS skills, tw_open, tw_close, speed_factor, max_tasks FROM vehicles',
    'breaks',
    'breaks_time_windows',
    'matrix'
  );
  ...
  SELECT set_eq('problem_speed_factor_5times_scaled',
    $$
      ...
      (4, 1, 1, 4, 3, 5, 1500, 0, 2250, 11850, ARRAY[40]),
      (5, 1, 1, 5, 3, 3, 15610, 10, 2250, 0, ARRAY[60]),
      (6, 1, 1, 6, 4, 5, 17870, 10, 2250, 305, ARRAY[50]),
      (7, 1, 1, 7, 4, 3, 20425, 0, 2250, 200, ARRAY[30]),
      (8, 1, 1, 8, 6, -1, 22885, 10, 0, 0, ARRAY[30]),
      (9, 1, 1, 0, 0, 0, 0, 40, 9250, 13295, ARRAY[]::INTEGER[]),
      (10, 2, 2, 1, 1, -1, 275, 0, 0, 0, ARRAY[70]),
      (11, 2, 2, 2, 5, 2, 275, 0, 10, 0, ARRAY[70]),
      (12, 2, 2, 3, 2, 5, 300, 15, 250, 725, ARRAY[70]),
      (13, 2, 2, 4, 2, 3, 1285, 10, 250, 1440, ARRAY[70]),
      (14, 2, 2, 5, 2, 4, 2975, 0, 250, 550, ARRAY[70]),
      (15, 2, 2, 6, 6, -1, 3775, 0, 0, 0, ARRAY[70]),
      (16, 2, 2, 0, 0, 0, 0, 25, 760, 2715, ARRAY[]::INTEGER[]),
      (17, 3, 3, 1, 1, -1, 0, 0, 0, 0, ARRAY[20]),
      (18, 3, 3, 2, 5, 3, 0, 0, 0, 0, ARRAY[20]),
      (19, 3, 3, 3, 2, 1, 0, 0, 250, 3625, ARRAY[20]),
      (20, 3, 3, 4, 3, 4, 3875, 0, 2250, 2500, ARRAY[40]),
      (21, 3, 3, 5, 4, 4, 8640, 15, 2250, 285, ARRAY[20]),
      (22, 3, 3, 6, 6, -1, 11190, 15, 0, 0, ARRAY[20]),
      (23, 3, 3, 0, 0, 0, 0, 30, 4750, 6410, ARRAY[]::INTEGER[]),
      (24, 4, 4, 1, 1, -1, 250, 0, 0, 0, ARRAY[0]),
      (25, 4, 4, 2, 5, 4, 250, 0, 0, 0, ARRAY[0]),
      (26, 4, 4, 3, 3, 2, 255, 5, 2250, 120, ARRAY[10]),
      (27, 4, 4, 4, 3, 1, 2630, 5, 2250, 0, ARRAY[20]),
      (28, 4, 4, 5, 4, 2, 4898, 18, 2250, 0, ARRAY[10]),
      (29, 4, 4, 6, 4, 1, 7170, 22, 2250, 17755, ARRAY[0]),
      (30, 4, 4, 7, 6, -1, 27180, 5, 0, 0, ARRAY[0]),
      (31, 4, 4, 0, 0, 0, 0, 55, 9000, 17875, ARRAY[]::INTEGER[]),
      (32, 0, 0, 0, 0, 0, 0, 150, 23760, 40295, ARRAY[]::INTEGER[])
    $$,
