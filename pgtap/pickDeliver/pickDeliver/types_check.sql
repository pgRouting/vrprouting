...
SELECT function_returns('_vrp_pickdeliver',
    ARRAY['text','text', 'text', 'double precision', 'integer', 'integer'],
    'setof record');

-- testing column names
SELECT set_eq(
    $$SELECT  proargnames from pg_proc where proname = 'vrp_pickdeliver'$$,
...
-- parameter types
SELECT set_eq(
    $$SELECT  proallargtypes from pg_proc where proname = 'vrp_pickdeliver'$$,
