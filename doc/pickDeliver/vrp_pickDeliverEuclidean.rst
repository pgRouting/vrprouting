...
* Supported Versions
  `Latest <https://vrp.pgrouting.org/latest/en/vrp_pickDeliverEuclidean.html>`__
  (`0.0 <https://vrp.pgrouting.org/0/en/vrp_pickDeliverEuclidean.html>`__)

vrp_pickDeliverEuclidean - Experimental
===============================================================================

``vrp_pickDeliverEuclidean`` - Pickup and delivery Vehicle Routing Problem
...
.. include:: ../sql/pickDeliver/pickDeliverEuclidean.sql
